    ...
    <div className="min-h-screen flex flex-col bg-[#f8f9fa]">
      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="card-elevated p-8">
                <h2 className="text-2xl font-bold text-[#1e3a5f] mb-4">{t('sustainability.esd')}</h2>
                <p className="text-gray-700 leading-relaxed">{t('sustainability.esdDesc')}</p>
              </div>
              <div className="card-elevated p-8">
                <h2 className="text-2xl font-bold text-[#1e3a5f] mb-4">{t('sustainability.csi')}</h2>
        ...
        <section className="py-20 bg-gradient-to-r from-[#1e3a5f]/5 to-[#c9a961]/5">
          <div className="container mx-auto">
            <h2 className="text-4xl font-bold text-[#1e3a5f] mb-12 text-center">{t('sustainability.environmental')}</h2>
              ...
              {initiatives.map((initiative, idx) => {
                ...
                return (
                  <div key={idx} className="card-elevated p-8 hover:shadow-xl transition-all duration-200 ease-out">
                    ...
                    <h3 className="text-xl font-bold text-[#1e3a5f] mb-3">{initiative.title}</h3>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              />
              <div>
                <h2 className="text-4xl font-bold text-[#1e3a5f] mb-6">Our Commitment</h2>
